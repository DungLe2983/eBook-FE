...
import { getBookById, updateBookStockQuantity } from "../services/bookService";
  ...
  const handleCreateOrder = async () => {
    try {
      ...
      for (const item of cartItems) {
        ...
        await updateBookStockQuantity(bookId, quantity);
      }

      // 6. Hiển thị thông báo thành công và điều hướng đến trang success
      toast.success("Đặt hàng thành công");
      setTimeout(() => {
        navigate("/success");
      }, 1500);
